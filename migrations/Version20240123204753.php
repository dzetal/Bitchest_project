 ...
 */
final class Version20240123204753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_wallet_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64971C5AD17 (user_wallet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64971C5AD17 FOREIGN KEY (user_wallet_id) REFERENCES wallet (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D64971C5AD17');
        $this->addSql('ALTER TABLE user_transaction DROP FOREIGN KEY FK_DB2CCC44A76ED395');
        $this->addSql('ALTER TABLE user_transaction DROP FOREIGN KEY FK_DB2CCC442FC0CB0F');
