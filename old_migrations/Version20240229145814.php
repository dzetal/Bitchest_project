 ...
 */
final class Version20240229145814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD profil_picture VARCHAR(255) NOT NULL, CHANGE fristname firstname VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD fristname VARCHAR(255) NOT NULL, DROP firstname, DROP profil_picture');
    }
}
